...
length_airbox = 5;    // Length of the airbox
height_airbox = 5;    // Height of the airbox

// Define points (in the 2D plane)
Point(1) = {0, 0, 0, 1};                        // Center of the conducting cylinder
Point(2) = {length_airbox/2, height_airbox/2, 0, 0.8};  // Top-right corner of the airbox
Point(3) = {-length_airbox/2, height_airbox/2, 0, 0.8}; // Top-left corner of the airbox
Point(4) = {-length_airbox/2, -height_airbox/2, 0, 0.8}; // Bottom-left corner of the airbox
Point(5) = {length_airbox/2, -height_airbox/2, 0, 0.8};  // Bottom-right corner of the airbox
...
Point(11) = {0, radius_cylinder, 0, 0.022};  
Point(12) = {radius_cylinder, 0, 0, 0.022};  
Point(13) = {0, -radius_cylinder, 0, 0.022}; 
Point(14) = {-radius_cylinder, 0, 0, 0.022}; 
